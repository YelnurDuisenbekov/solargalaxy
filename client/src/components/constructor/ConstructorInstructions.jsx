const STEPS = [
  ...
  },
  {
    ...
    text: 'Режим «Рёбра крыши» → два клика по линии ребра (линия, вдоль которой скаты идут под углом). Можно несколько рёбер. Для каждого ребра включайте/выключайте стороны А и Б — активные зоны для панелей.',
  },
  {
